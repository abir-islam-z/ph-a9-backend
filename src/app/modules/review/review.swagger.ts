 ...
 *         id:
 *           type: string
 *           description: Auto-generated unique identifier for the review
 *         rating:
 *           type: number
 *           minimum: 1
 *           maximum: 5
 ...
 *         foodSpotId:
 *           type: string
 *           description: ID of the food spot being reviewed
 *         userId:
 *           type: string
 ...
 *           type: string
 *           format: date-time
 *           description: Time when the review was last updated
 *       example:
...
/**
 * @swagger
 * /reviews/food-spot/{foodSpotId}:
 *   get:
 *     summary: Get all reviews for a specific food spot
 *     tags: [Reviews]
 *     parameters:
 *       - in: path
 *         name: foodSpotId
